...
import com.brent.restservices.dtos.UserDtoV1;
import com.brent.restservices.dtos.UserDtoV2;
...
public class UserMedaiTypeVersioningController {
	...
	//Autowire the UserService
		...
		@GetMapping(value = "/{id}", produces = "application/vnd.brent.app-v1+json")
		...
		@GetMapping(value = "/{id}", produces = "application/vnd.brent.app-v2+json")
